...
class Form
{
    ...
    */
    ...
    /**
    * Check if a provided request parameter name's value matches with a given value
    * Return true if match else false
    * Example usage:
    *   $email = $this->isMatch('shipType', 'express');
    */
    public function isMatch($name, $value)
    {
        $value = (isset($this->request[$name]) && $this->request[$name]==$value)  ? true : false;
    ...
    */
    ...
    /**
    * Returns boolean if the given value is a valid zipcode
    */
